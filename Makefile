...
all: bin/procseqs.out bin/fastaseqs-to-distmatrix.out bin/linsetcover.out bin/setcover-ords-to-hdrs.out bin/setcover-ords-to-fasta.out \
...
bin/linsetcover.out             : src/linsetcover.cpp
	$(CXX) src/linsetcover.cpp             -o bin/linsetcover.out             $(OUTFLAGS) -fopenmp
